...
JNIEXPORT jint JNICALL Java_com_miracles_codec_camera_LibYuvUtils_scaleRotationAndMirrorToI420
        (JNIEnv *, jclass, jbyteArray, jint, jbyteArray, jint, jint, jint, jint, jint, jint, jboolean, jint, jint, jint,
         jint, jint);
 ...
 * Signature: ([BI[BIII)I
 */
JNIEXPORT void JNICALL Java_com_miracles_codec_camera_LibYuvUtils_cropI420
